...
func goldenFixtures() map[string]goldenCase {
	...
	return map[string]goldenCase{
		...
		"content_resource_link": {
			...
			value: func() any {
				return acp.ContentBlock{Type: acp.ContentBlockTypeResourceLink, URI: "file:///home/user/document.pdf", Name: "document.pdf", MimeType: "application/pdf", Size: int64Ptr(1024000)}
			},
		},
		...
		"session_update_config_option_update":         sessionUpdateGolden(`{"sessionUpdate":"config_option_update","configOptions":[{"type":"select","currentValue":"gpt-4o-mini","options":[{"name":"GPT-4o Mini","value":"gpt-4o-mini"},{"name":"GPT-4o","value":"gpt-4o","description":"Highest quality"}]},{"type":"select","currentValue":"fast","options":[{"group":"speed","name":"Speed","options":[{"name":"Fast","value":"fast"},{"name":"Balanced","value":"balanced"}]},{"group":"quality","name":"Quality","options":[{"name":"High","value":"high"}]}]}]}`, acp.SessionUpdate{SessionUpdate: "config_option_update", ConfigOptions: []acp.SessionConfigOption{{Type: "select", CurrentValue: acp.SessionConfigValueId("gpt-4o-mini"), Options: acp.SessionConfigSelectOptions{Ungrouped: genericPtr(acp.UngroupedSessionConfigSelectOptions{{Name: "GPT-4o Mini", Value: "gpt-4o-mini"}, {Name: "GPT-4o", Value: "gpt-4o", Description: stringPtr("Highest quality")}})}}, {Type: "select", CurrentValue: acp.SessionConfigValueId("fast"), Options: acp.SessionConfigSelectOptions{Groups: genericPtr(acp.GroupedSessionConfigSelectOptions{{Group: "speed", Name: "Speed", Options: []acp.SessionConfigSelectOption{{Name: "Fast", Value: "fast"}, {Name: "Balanced", Value: "balanced"}}}, {Group: "quality", Name: "Quality", Options: []acp.SessionConfigSelectOption{{Name: "High", Value: "high"}}}})}}}}),
		...
		"set_session_config_option_request": {
			raw:    `{"value":"gpt-4o-mini"}`,
			decode: func() any { return &acp.SetSessionConfigOptionRequest{} },
			value: func() any {
				return acp.SetSessionConfigOptionRequest{Value: "gpt-4o-mini"}
			},
		},
		"set_session_config_option_response": {
			raw:    `{"configOptions":[{"type":"select","currentValue":"balanced","options":[{"name":"Fast","value":"fast"},{"name":"Balanced","value":"balanced"}]}]}`,
			decode: func() any { return &acp.SetSessionConfigOptionResponse{} },
			value: func() any {
				return acp.SetSessionConfigOptionResponse{ConfigOptions: []acp.SessionConfigOption{{Type: "select", CurrentValue: acp.SessionConfigValueId("balanced"), Options: acp.SessionConfigSelectOptions{Ungrouped: genericPtr(acp.UngroupedSessionConfigSelectOptions{{Name: "Fast", Value: "fast"}, {Name: "Balanced", Value: "balanced"}})}}}}
			},
		},
