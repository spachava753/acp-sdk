...
func goldenFixtures() map[string]goldenCase {
	...
	return map[string]goldenCase{
		...
		"content_resource_link": {
			...
			value: func() any {
				return acp.ContentBlock{Type: acp.ContentTypeLink, URI: "file:///home/user/document.pdf", Name: "document.pdf", MIMEType: "application/pdf", Size: int64Ptr(1024000)}
			},
		},
		"content_resource_text": {
			...
			decode: func() any { return &acp.ContentBlock{} },
			value: func() any {
				return acp.ContentBlock{Type: acp.ContentTypeResource, Resource: &acp.ResourceContents{URI: "file:///home/user/script.py", MIMEType: "text/x-python", Text: "def hello():\n    print('Hello, world!')"}}
			},
		},
		"content_text": {
			raw:    `{"type":"text","text":"What's the weather like today?"}`,
			decode: func() any { return &acp.ContentBlock{} },
			value:  func() any { return acp.ContentBlock{Type: acp.ContentTypeText, Text: "What's the weather like today?"} },
		},
		"fs_read_text_file_request": {
			...
			value: func() any {
				return acp.ReadTextFileRequest{SessionID: sess, Path: "/home/user/project/src/main.py", Line: intPtr(10), Limit: intPtr(50)}
			},
		},
		...
		"initialize_request": {
			...
			value: func() any {
				return acp.InitializeRequest{ProtocolVersion: acp.ProtocolVersion, ClientCapabilities: &acp.ClientCapabilities{FS: &acp.FileSystemCapabilities{ReadTextFile: true, WriteTextFile: true}}}
			},
		},
		"initialize_response": {
			raw:    `{"protocolVersion":1,"agentCapabilities":{"loadSession":true,"mcpCapabilities":{},"promptCapabilities":{"image":true,"audio":true,"embeddedContext":true},"sessionCapabilities":{}},"authMethods":[]}`,
			decode: func() any { return &acp.InitializeResponse{} },
			value: func() any {
				return acp.InitializeResponse{ProtocolVersion: acp.ProtocolVersion, AgentCapabilities: &acp.AgentCapabilities{LoadSession: true, MCPCapabilities: &acp.MCPCapabilities{}, PromptCapabilities: &acp.PromptCapabilities{Image: true, Audio: true, EmbeddedContext: true}, SessionCapabilities: &acp.SessionCapabilities{}}, AuthMethods: []acp.AuthMethod{}}
			},
		},
		"new_session_request": {
		...
		"prompt_request": {
			...
			value: func() any {
				return acp.PromptRequest{SessionID: sess, Prompt: []acp.ContentBlock{{Type: acp.ContentTypeText, Text: "Can you analyze this code for potential issues?"}, {Type: acp.ContentTypeResource, Resource: &acp.ResourceContents{URI: "file:///home/user/project/main.py", MIMEType: "text/x-python", Text: "def process_data(items):\n    for item in items:\n        print(item)"}}}}
			},
		},
		"request_permission_request": {
			...
			value: func() any {
				return acp.RequestPermissionRequest{SessionID: sess, ToolCall: acp.ToolCallUpdate{ToolCallID: "call_001"}, Options: []acp.PermissionOption{{OptionID: "allow-once", Name: "Allow once", Kind: acp.PermissionAllowOnce}, {OptionID: "reject-once", Name: "Reject", Kind: acp.PermissionRejectOnce}}}
			},
		},
		...
		"session_update_agent_message_chunk":          sessionUpdateGolden(`{"sessionUpdate":"agent_message_chunk","content":{"type":"text","text":"The capital of France is Paris."}}`, acp.SessionUpdate{SessionUpdate: "agent_message_chunk", Content: acp.ContentBlock{Type: acp.ContentTypeText, Text: "The capital of France is Paris."}}),
		"session_update_agent_thought_chunk":          sessionUpdateGolden(`{"sessionUpdate":"agent_thought_chunk","content":{"type":"text","text":"Thinking about best approach..."}}`, acp.SessionUpdate{SessionUpdate: "agent_thought_chunk", Content: acp.ContentBlock{Type: acp.ContentTypeText, Text: "Thinking about best approach..."}}),
		"session_update_config_option_update":         sessionUpdateGolden(`{"sessionUpdate":"config_option_update","configOptions":[{"type":"select","id":"model","name":"Model","description":"Choose a model","currentValue":"gpt-4o-mini","options":[{"name":"GPT-4o Mini","value":"gpt-4o-mini"},{"name":"GPT-4o","value":"gpt-4o","description":"Highest quality"}]},{"type":"select","id":"mode","name":"Mode","currentValue":"fast","options":[{"group":"speed","name":"Speed","options":[{"name":"Fast","value":"fast"},{"name":"Balanced","value":"balanced"}]},{"group":"quality","name":"Quality","options":[{"name":"High","value":"high"}]}]}]}`, acp.SessionUpdate{SessionUpdate: "config_option_update", ConfigOptions: []acp.SessionConfigOption{{Type: "select", ID: "model", Name: "Model", Description: "Choose a model", CurrentValue: "gpt-4o-mini", Options: acp.SessionConfigSelectOptions{Flat: []acp.SessionConfigSelectOption{{Name: "GPT-4o Mini", Value: "gpt-4o-mini"}, {Name: "GPT-4o", Value: "gpt-4o", Description: "Highest quality"}}}}, {Type: "select", ID: "mode", Name: "Mode", CurrentValue: "fast", Options: acp.SessionConfigSelectOptions{Groups: []acp.SessionConfigSelectGroup{{Group: "speed", Name: "Speed", Options: []acp.SessionConfigSelectOption{{Name: "Fast", Value: "fast"}, {Name: "Balanced", Value: "balanced"}}}, {Group: "quality", Name: "Quality", Options: []acp.SessionConfigSelectOption{{Name: "High", Value: "high"}}}}}}}}),
		...
		"session_update_tool_call":                    sessionUpdateGolden(`{"sessionUpdate":"tool_call","toolCallId":"call_001","title":"Reading configuration file","kind":"read","status":"pending"}`, acp.SessionUpdate{SessionUpdate: "tool_call", ToolCallID: "call_001", Title: stringPtr("Reading configuration file"), Kind: acp.ToolKindRead, Status: acp.ToolCallPending}),
		"session_update_tool_call_edit":               sessionUpdateGolden(`{"sessionUpdate":"tool_call","toolCallId":"call_003","title":"Apply edit","kind":"edit","status":"pending","locations":[{"path":"/home/user/project/src/config.json"}],"rawInput":{"content":"print('hello')","path":"/home/user/project/src/config.json"}}`, acp.SessionUpdate{SessionUpdate: "tool_call", ToolCallID: "call_003", Title: stringPtr("Apply edit"), Kind: acp.ToolKindEdit, Status: acp.ToolCallPending, Locations: []acp.ToolCallLocation{{Path: "/home/user/project/src/config.json"}}, RawInput: map[string]any{"path": "/home/user/project/src/config.json", "content": "print('hello')"}}),
		"session_update_tool_call_locations_rawinput": sessionUpdateGolden(`{"sessionUpdate":"tool_call","toolCallId":"call_lr","title":"Tracking file","locations":[{"path":"/home/user/project/src/config.json"}],"rawInput":{"path":"/home/user/project/src/config.json"}}`, acp.SessionUpdate{SessionUpdate: "tool_call", ToolCallID: "call_lr", Title: stringPtr("Tracking file"), Locations: []acp.ToolCallLocation{{Path: "/home/user/project/src/config.json"}}, RawInput: map[string]any{"path": "/home/user/project/src/config.json"}}),
		"session_update_tool_call_read":               sessionUpdateGolden(`{"sessionUpdate":"tool_call","toolCallId":"call_001","title":"Reading configuration file","kind":"read","status":"pending","locations":[{"path":"/home/user/project/src/config.json"}],"rawInput":{"path":"/home/user/project/src/config.json"}}`, acp.SessionUpdate{SessionUpdate: "tool_call", ToolCallID: "call_001", Title: stringPtr("Reading configuration file"), Kind: acp.ToolKindRead, Status: acp.ToolCallPending, Locations: []acp.ToolCallLocation{{Path: "/home/user/project/src/config.json"}}, RawInput: map[string]any{"path": "/home/user/project/src/config.json"}}),
		"session_update_tool_call_update_content":     sessionUpdateGolden(`{"sessionUpdate":"tool_call_update","toolCallId":"call_001","status":"in_progress","content":[{"type":"content","content":{"type":"text","text":"Found 3 configuration files..."}}]}`, acp.SessionUpdate{SessionUpdate: "tool_call_update", ToolCallID: "call_001", Status: acp.ToolCallInProgress, Content: []acp.ToolCallContent{{Type: acp.ToolCallContentTypeContent, Content: &acp.ContentBlock{Type: acp.ContentTypeText, Text: "Found 3 configuration files..."}}}}),
		"session_update_tool_call_update_more_fields": sessionUpdateGolden(`{"sessionUpdate":"tool_call_update","toolCallId":"call_010","title":"Processing changes","kind":"edit","status":"completed","locations":[{"path":"/home/user/project/src/config.json"}],"rawInput":{"path":"/home/user/project/src/config.json"},"rawOutput":{"result":"ok"},"content":[{"type":"content","content":{"type":"text","text":"Edit completed."}}]}`, acp.SessionUpdate{SessionUpdate: "tool_call_update", ToolCallID: "call_010", Title: stringPtr("Processing changes"), Kind: acp.ToolKindEdit, Status: acp.ToolCallCompleted, Locations: []acp.ToolCallLocation{{Path: "/home/user/project/src/config.json"}}, RawInput: map[string]any{"path": "/home/user/project/src/config.json"}, RawOutput: map[string]any{"result": "ok"}, Content: []acp.ToolCallContent{{Type: acp.ToolCallContentTypeContent, Content: &acp.ContentBlock{Type: acp.ContentTypeText, Text: "Edit completed."}}}}),
		"session_update_user_message_chunk":           sessionUpdateGolden(`{"sessionUpdate":"user_message_chunk","content":{"type":"text","text":"What's the capital of France?"}}`, acp.SessionUpdate{SessionUpdate: "user_message_chunk", Content: acp.ContentBlock{Type: acp.ContentTypeText, Text: "What's the capital of France?"}}),
		"set_session_config_option_request": {
			raw:    `{"sessionId":"sess-123","configId":"model","value":"gpt-4o-mini"}`,
			decode: func() any { return &acp.SetSessionConfigOptionRequest{} },
			value: func() any {
				return acp.SetSessionConfigOptionRequest{SessionID: "sess-123", ConfigID: "model", Value: "gpt-4o-mini"}
			},
		},
		"set_session_config_option_response": {
			raw:    `{"configOptions":[{"type":"select","id":"mode","name":"Mode","currentValue":"balanced","options":[{"name":"Fast","value":"fast"},{"name":"Balanced","value":"balanced"}]}]}`,
			decode: func() any { return &acp.SetSessionConfigOptionResponse{} },
			value: func() any {
				return acp.SetSessionConfigOptionResponse{ConfigOptions: []acp.SessionConfigOption{{Type: "select", ID: "mode", Name: "Mode", CurrentValue: "balanced", Options: acp.SessionConfigSelectOptions{Flat: []acp.SessionConfigSelectOption{{Name: "Fast", Value: "fast"}, {Name: "Balanced", Value: "balanced"}}}}}}
			},
		},
		"tool_content_content_text": toolContentGolden(`{"type":"content","content":{"type":"text","text":"Analysis complete. Found 3 issues."}}`, acp.ToolCallContent{Type: acp.ToolCallContentTypeContent, Content: &acp.ContentBlock{Type: acp.ContentTypeText, Text: "Analysis complete. Found 3 issues."}}),
